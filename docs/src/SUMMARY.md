...
- [First Scan](tutorials/first-scan.md)

# User Guide
- [Basic Usage](tutorials/basic-usage.md)
- [Advanced Features](tutorials/advanced-usage.md)
- [Configuration](configuration/overview.md)
- [Custom Detectors](tutorials/custom-detectors.md)
...
- [Architecture Decisions](architecture/decisions/README.md)
  - [ADR-001: Modular Crate Structure](architecture/decisions/ADR-001-modular-crate-structure.md)
  - [ADR-002: Performance Optimization Strategy](architecture/decisions/ADR-002-performance-optimization.md)
...
- [Library Usage](examples/library.md)
- [Custom Detectors](examples/custom-detectors.md)
